...
def test_android_power_automation_binds_public_https_ssh_and_smartthings_autoselect():
    sources = _android_sources()
    ...
    for marker in [
        ...
        "openVpnSettings",
        "PUBLIC_REMOTE_AGENT_SCHEME",
        "PUBLIC_IP_DNS_SUFFIX",
        "SSLIP_DASH_IPV4_PATTERN",
        "sslip.io",
        "Connection Doctor",
        "공유기 공인 IP",
        "TCP 443",
...
def test_android_realhost_repair_and_resource_diagnostics_are_present():
    ...
    for marker in [
        ...
        "Public HTTPS direct mode never toggles VPN state",
        "onRepairEnvironment",
        'replace("&amp;", "&")',
        "iconFailed",
