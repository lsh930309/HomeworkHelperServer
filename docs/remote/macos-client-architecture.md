...
Status: Active reference for the macOS Remote Client
...
- Mobile/game-link data model retained by the host API: `/remote/game-links`, `/remote/mobile-sessions/active`, `/remote/mobile-sessions/start`, `/remote/mobile-sessions/end`.
