...
| BEHOLDER-001 | 데이터 안전 감시 | complete | partial | high | 사용자 친화 incident UX/내부 코드명 없는 위험 라벨/DB 요약 백업 preview/스마트 세션 복구/actor별 필드·값 범위 guard 및 세션 종료 스태미나 guard 유지, Windows 복구 smoke 필요 |
