...
a = Analysis(
    ...
    hiddenimports=['uvicorn', 'fastapi', 'sqlalchemy', 'requests', 'PyQt6', 'psutil', 'win32api', 'win32security', 'win32process', 'win32con', 'win32com.client', 'cv2', 'av', 'skimage', 'skimage.metrics', 'skimage._shared', 'skimage._shared.utils', 'timeit', 'pickletools', 'pickle', 'copyreg', 'types', 'weakref', 'struct', 'modulefinder', 'matplotlib'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
