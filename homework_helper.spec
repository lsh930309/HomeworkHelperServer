...
a = Analysis(
    ...
    hiddenimports=['uvicorn', 'fastapi', 'sqlalchemy', 'requests', 'PyQt6', 'psutil', 'win32api', 'win32security', 'win32process', 'win32con', 'win32com.client', 'cv2', 'skimage', 'skimage.metrics', 'skimage._shared', 'skimage._shared.utils'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
